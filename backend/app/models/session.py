...
Index("ix_session_task_logs_task_created", SessionTaskLog.task_id, SessionTaskLog.created_at)
Index("ix_session_task_logs_task_status_created", SessionTaskLog.task_id, SessionTaskLog.status, SessionTaskLog.created_at)
